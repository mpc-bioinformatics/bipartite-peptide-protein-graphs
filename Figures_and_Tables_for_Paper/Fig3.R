...
pl2 <- ggplot(D_long_tmp3) +
  ...
  theme(legend.position = "bottom", plot.margin = plot_margins, 
        legend.key.size = legend.key.size, legend.margin=margin(t = -5)) +
  ylab(ylab) + xlab(xlab) +
  ggtitle(paste0("Does graph have ", intToUtf8(8805), " 1 protein \nnode without unique peptides?"))+
...
ggsave(pl = pl_panel,"Paper/Paper 1/figures/Fig3_350dpi.jpg", device = "jpeg", units = "cm", height = 10, width = 8.6, dpi = 350)
ggsave(pl = pl_panel,"Paper/Paper 1/figures/Fig3_350dpi.eps", device = "eps", units = "cm", height = 10, width = 8.6, dpi = 350)
ggsave(pl = pl_panel,"Paper/Paper 1/figures/Fig3_1200dpi.tif", device = "tiff", units = "cm", height = 10, width = 8.6, dpi = 1200)
ggsave(pl = pl_panel,"Paper/Paper 1/figures/Fig3_350dpi.tif",  device = "tiff", units = "cm", height = 10, width = 8.6, dpi = 350)
