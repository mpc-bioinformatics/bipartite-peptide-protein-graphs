...
save(list =  ls(pattern = "isomorph"), 
     file = "data/D2/D2_quant/isomorph_classes/isomorph_classes.RData")
...
save(list =  ls(pattern = "isomorph_merged"), 
     file = "data/D2/D2_quant/isomorph_classes/isomorph_classes_merged_Peptides.RData")
...
isomorph_all <- calculateIsomorphList(Submatrix_all)
save(isomorph_all, file = "data/D2/D2_quant/isomorph_classes/isomorph_classes_all.RData")

load("data/D2/D2_quant//preprocessed/Submatrices_merged_Peptides.RData")
Submatrix_all_merged_Peptides <- do.call(c, args = mget(ls(pattern = "Submatrix_merged_Peptides")))
isomorph_all_merged_Peptides <- calculateIsomorphList(Submatrix_all_merged_Peptides)
save(isomorph_all_merged_Peptides, file = "data/D2/D2_quant//isomorph_classes/isomorph_classes_all_merged_Peptides.RData")
